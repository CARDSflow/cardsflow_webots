...
int main(int argc, char **argv) {
  ...
  ros::ServiceClient deviceListClient =
    n.serviceClient<cardsflow_webots::robot_get_device_list>(controllerName + "/robot/get_device_list");
  cardsflow_webots::robot_get_device_list deviceListSrv;
  ...
  ros::ServiceClient rangeFinderGetInfoClient =
    n.serviceClient<cardsflow_webots::range_finder_get_info>(controllerName + '/' + rangeFinderName + "/get_info");
  cardsflow_webots::range_finder_get_info rangeFinderGetInfoSrv;
  ...
  ros::ServiceClient enableRangeFinderClient =
    n.serviceClient<cardsflow_webots::set_int>(controllerName + '/' + rangeFinderName + "/enable");
  cardsflow_webots::set_int enableRangeFinderSrv;
  ...
  ros::ServiceClient rangeFinderSaveImageClient =
    n.serviceClient<cardsflow_webots::save_image>(controllerName + '/' + rangeFinderName + "/save_image");
  cardsflow_webots::save_image rangeFinderSaveImageSrv;
  ...
  ros::ServiceClient motorSetPositionClient =
    n.serviceClient<cardsflow_webots::set_float>(controllerName + '/' + motorName + "/set_position");
  cardsflow_webots::set_float motorSetPositionSrv;
  motorSetPositionSrv.request.value = 0;
  i = 0.2;
  step = 0.025;

  ros::ServiceClient motorGetTargetPositionClient =
    n.serviceClient<cardsflow_webots::get_float>(controllerName + '/' + motorName + "/get_target_position");
  cardsflow_webots::get_float motorGetTargetPositionSrv;

...
void updateSpeed() {
  ...
  for (int i = 0; i < NMOTORS; ++i) {
    ...
    set_velocity_client = n->serviceClient<cardsflow_webots::set_float>(std::string("pioneer3at/") + std::string(motorNames[i]) +
...
int main(int argc, char **argv) {
  ...
  timeStepClient = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/robot/time_step");
  ...
  for (int i = 0; i < NMOTORS; ++i) {
    ...
    set_position_client = n->serviceClient<cardsflow_webots::set_float>(std::string("pioneer3at/") + std::string(motorNames[i]) +
  ...
  set_lidar_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/Sick_LMS_291/enable");
  ...
  set_GPS_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/gps/enable");
  ...
  set_inertial_unit_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/inertial_unit/enable");
  ...
  set_accelerometer_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/accelerometer/enable");
  ...
  set_camera_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/camera/enable");
  ...
  set_gyro_client = n->serviceClient<cardsflow_webots::set_int>("pioneer3at/gyro/enable");

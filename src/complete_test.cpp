...
#include <cardsflow_webots/BoolStamped.h>
#include <cardsflow_webots/Float64Stamped.h>
#include <cardsflow_webots/Int32Stamped.h>
#include <cardsflow_webots/Int8Stamped.h>
#include <cardsflow_webots/RadarTarget.h>
#include <cardsflow_webots/RecognitionObject.h>
#include <cardsflow_webots/StringStamped.h>
#include <cstdlib>
#include "ros/ros.h"

#include <cardsflow_webots/get_bool.h>
#include <cardsflow_webots/get_float.h>
#include <cardsflow_webots/get_int.h>
#include <cardsflow_webots/get_string.h>
#include <cardsflow_webots/get_uint64.h>
#include <cardsflow_webots/set_bool.h>
#include <cardsflow_webots/set_float.h>
#include <cardsflow_webots/set_float_array.h>
#include <cardsflow_webots/set_int.h>
#include <cardsflow_webots/set_string.h>

#include <cardsflow_webots/camera_get_focus_info.h>
#include <cardsflow_webots/camera_get_info.h>
#include <cardsflow_webots/camera_get_zoom_info.h>
#include <cardsflow_webots/display_draw_line.h>
#include <cardsflow_webots/display_draw_oval.h>
#include <cardsflow_webots/display_draw_pixel.h>
#include <cardsflow_webots/display_draw_polygon.h>
#include <cardsflow_webots/display_draw_rectangle.h>
#include <cardsflow_webots/display_draw_text.h>
#include <cardsflow_webots/display_get_info.h>
#include <cardsflow_webots/display_image_copy.h>
#include <cardsflow_webots/display_image_delete.h>
#include <cardsflow_webots/display_image_load.h>
#include <cardsflow_webots/display_image_new.h>
#include <cardsflow_webots/display_image_paste.h>
#include <cardsflow_webots/display_image_save.h>
#include <cardsflow_webots/display_set_font.h>
#include <cardsflow_webots/field_get_bool.h>
#include <cardsflow_webots/field_get_color.h>
#include <cardsflow_webots/field_get_count.h>
#include <cardsflow_webots/field_get_float.h>
#include <cardsflow_webots/field_get_int32.h>
#include <cardsflow_webots/field_get_node.h>
#include <cardsflow_webots/field_get_rotation.h>
#include <cardsflow_webots/field_get_string.h>
#include <cardsflow_webots/field_get_type.h>
#include <cardsflow_webots/field_get_type_name.h>
#include <cardsflow_webots/field_get_vec2f.h>
#include <cardsflow_webots/field_get_vec3f.h>
#include <cardsflow_webots/field_import_node.h>
#include <cardsflow_webots/field_remove.h>
#include <cardsflow_webots/field_set_bool.h>
#include <cardsflow_webots/field_set_color.h>
#include <cardsflow_webots/field_set_float.h>
#include <cardsflow_webots/field_set_int32.h>
#include <cardsflow_webots/field_set_rotation.h>
#include <cardsflow_webots/field_set_string.h>
#include <cardsflow_webots/field_set_vec2f.h>
#include <cardsflow_webots/field_set_vec3f.h>
#include <cardsflow_webots/lidar_get_frequency_info.h>
#include <cardsflow_webots/lidar_get_info.h>
#include <cardsflow_webots/motor_set_control_pid.h>
#include <cardsflow_webots/node_get_center_of_mass.h>
#include <cardsflow_webots/node_get_contact_point.h>
#include <cardsflow_webots/node_get_field.h>
#include <cardsflow_webots/node_get_id.h>
#include <cardsflow_webots/node_get_name.h>
#include <cardsflow_webots/node_get_number_of_contact_points.h>
#include <cardsflow_webots/node_get_orientation.h>
#include <cardsflow_webots/node_get_parent_node.h>
#include <cardsflow_webots/node_get_position.h>
#include <cardsflow_webots/node_get_static_balance.h>
#include <cardsflow_webots/node_get_status.h>
#include <cardsflow_webots/node_get_type.h>
#include <cardsflow_webots/node_get_velocity.h>
#include <cardsflow_webots/node_remove.h>
#include <cardsflow_webots/node_reset_functions.h>
#include <cardsflow_webots/node_set_velocity.h>
#include <cardsflow_webots/node_set_visibility.h>
#include <cardsflow_webots/pen_set_ink_color.h>
#include <cardsflow_webots/range_finder_get_info.h>
#include <cardsflow_webots/receiver_get_emitter_direction.h>
#include <cardsflow_webots/robot_get_device_list.h>
#include <cardsflow_webots/robot_set_mode.h>
#include <cardsflow_webots/robot_wait_for_user_input_event.h>
#include <cardsflow_webots/save_image.h>
#include <cardsflow_webots/speaker_play_sound.h>
#include <cardsflow_webots/speaker_speak.h>
#include <cardsflow_webots/supervisor_get_from_def.h>
#include <cardsflow_webots/supervisor_get_from_id.h>
#include <cardsflow_webots/supervisor_movie_start_recording.h>
#include <cardsflow_webots/supervisor_set_label.h>
#include <cardsflow_webots/supervisor_virtual_reality_headset_get_orientation.h>
#include <cardsflow_webots/supervisor_virtual_reality_headset_get_position.h>
...
cardsflow_webots::set_int time_step_srv;
...
void joystickCallback(const cardsflow_webots::Int8Stamped::ConstPtr &value) {
  ROS_INFO("Joystick button pressed: %d (time: %d:%d).", value->data, value->header.stamp.sec, value->header.stamp.nsec);
}

void keyboardCallback(const cardsflow_webots::Int32Stamped::ConstPtr &value) {
  ROS_INFO("Keyboard key pressed: %d (time: %d:%d).", value->data, value->header.stamp.sec, value->header.stamp.nsec);
}

void radarTargetsCallback(const cardsflow_webots::RadarTarget::ConstPtr &target) {
...
void radarTargetsNumberCallback(const cardsflow_webots::Int8Stamped::ConstPtr &value) {
...
void connectorCallback(const cardsflow_webots::Int8Stamped::ConstPtr &value) {
...
void battery_sensorCallback(const cardsflow_webots::Float64Stamped::ConstPtr &value) {
...
void GPSSpeedCallback(const cardsflow_webots::Float64Stamped::ConstPtr &value) {
...
void positionSensorCallback(const cardsflow_webots::Float64Stamped::ConstPtr &value) {
  ROS_INFO("Position sensor sent value %f (time: %d:%d).", value->data, value->header.stamp.sec, value->header.stamp.nsec);
}

void touchSensorCallback(const cardsflow_webots::Float64Stamped::ConstPtr &value) {
  ROS_INFO("Touch sensor sent value %f (time: %d:%d).", value->data, value->header.stamp.sec, value->header.stamp.nsec);
}

void touchSensorBumperCallback(const cardsflow_webots::BoolStamped::ConstPtr &value) {
...
void receiverCallback(const cardsflow_webots::StringStamped::ConstPtr &value) {
...
int main(int argc, char **argv) {
  ...
  time_step_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/robot/time_step");
  ...
  ros::ServiceClient get_number_of_devices_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/robot/get_number_of_devices");
  cardsflow_webots::get_int get_number_of_devices_srv;
  ...
  ros::ServiceClient device_list_client =
    n.serviceClient<cardsflow_webots::robot_get_device_list>(model_name + "/robot/get_device_list");
  cardsflow_webots::robot_get_device_list device_list_srv;
  ...
  ros::ServiceClient get_basic_time_step_client =
    n.serviceClient<cardsflow_webots::get_float>(model_name + "/robot/get_basic_time_step");
  cardsflow_webots::get_float get_basic_time_step_srv;
  ...
  ros::ServiceClient get_controller_arguments_client =
    n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_controller_arguments");
  cardsflow_webots::get_string get_controller_arguments_srv;
  ...
  ros::ServiceClient get_controller_name_client =
    n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_controller_name");
  cardsflow_webots::get_string get_controller_name_srv;
  ...
  ros::ServiceClient robot_get_custom_data_client =
    n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_custom_data");
  cardsflow_webots::get_string robot_get_custom_data_srv;
  ...
  ros::ServiceClient get_mode_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/robot/get_mode");
  cardsflow_webots::get_int get_mode_srv;
  ...
  ros::ServiceClient get_model_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_model");
  cardsflow_webots::get_string get_model_srv;
  ...
  ros::ServiceClient get_project_path_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_project_path");
  cardsflow_webots::get_string get_project_path_srv;
  ...
  ros::ServiceClient get_world_path_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/get_world_path");
  cardsflow_webots::get_string get_world_path_srv;
  ...
  ros::ServiceClient get_supervisor_client = n.serviceClient<cardsflow_webots::get_bool>(model_name + "/robot/get_supervisor");
  cardsflow_webots::get_bool get_supervisor_srv;
  ...
  ros::ServiceClient get_synchronization_client =
    n.serviceClient<cardsflow_webots::get_bool>(model_name + "/robot/get_synchronization");
  cardsflow_webots::get_bool get_synchronization_srv;
  ...
  ros::ServiceClient get_time_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/robot/get_time");
  cardsflow_webots::get_float get_time_srv;
  ...
  ros::ServiceClient get_type_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/robot/get_type");
  cardsflow_webots::get_int get_type_srv;
  ...
  ros::ServiceClient robot_set_custom_data_client =
    n.serviceClient<cardsflow_webots::set_string>(model_name + "/robot/set_custom_data");
  cardsflow_webots::set_string robot_set_custom_data_srv;
  ...
  ros::ServiceClient set_mode_client = n.serviceClient<cardsflow_webots::robot_set_mode>(model_name + "/robot/set_mode");
  cardsflow_webots::robot_set_mode set_mode_srv;
  ...
  ros::ServiceClient enable_keyboard_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/keyboard/enable");
  cardsflow_webots::set_int enable_keyboard_srv;
  ...
  ros::ServiceClient wait_for_user_input_event_client =
    n.serviceClient<cardsflow_webots::robot_wait_for_user_input_event>(model_name + "/robot/wait_for_user_input_event");
  cardsflow_webots::robot_wait_for_user_input_event wait_for_user_input_event_srv;
  ...
  ros::ServiceClient brake_set_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/my_brake/set_damping_constant");
  cardsflow_webots::set_float brake_set_srv;
  ...
  ros::ServiceClient brake_get_motor_name_client =
    n.serviceClient<cardsflow_webots::get_string>(model_name + "/my_brake/get_motor_name");
  cardsflow_webots::get_string brake_get_motor_name_srv;
  ...
  ros::ServiceClient camera_set_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/camera/set_focal_distance");
  cardsflow_webots::set_float camera_set_focal_distance_srv;
  ...
  // camera_set_fov
  double fov = 1.33;
  camera_set_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/camera/set_fov");
  cardsflow_webots::set_float camera_set_fov_srv;
  ...
  cardsflow_webots::set_int camera_srv;
  ros::Subscriber sub_camera_color;

  enable_camera_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/camera/enable");
  ...
  // camera_get_info
  ros::ServiceClient get_info_client = n.serviceClient<cardsflow_webots::camera_get_info>(model_name + "/camera/get_info");
  cardsflow_webots::camera_get_info get_info_srv;
  ...
  get_info_client = n.serviceClient<cardsflow_webots::camera_get_focus_info>(model_name + "/camera/get_focus_info");
  cardsflow_webots::camera_get_focus_info camera_get_focus_info_srv;
  ...
  get_info_client = n.serviceClient<cardsflow_webots::camera_get_zoom_info>(model_name + "/camera/get_zoom_info");
  cardsflow_webots::camera_get_zoom_info camera_get_zoom_info_srv;
  ...
  get_info_client = n.serviceClient<cardsflow_webots::get_bool>(model_name + "/camera/has_recognition");
  cardsflow_webots::get_bool camera_has_recognition_srv;
  ...
  // camera_save_image
  ros::ServiceClient save_image_client = n.serviceClient<cardsflow_webots::save_image>(model_name + "/camera/save_image");
  cardsflow_webots::save_image save_image_srv;
  ...
  // device_get_name
  ros::ServiceClient device_get_name_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/camera/get_name");
  cardsflow_webots::get_string device_get_name_srv;
  ...
  // device_get_name
  ros::ServiceClient device_get_model_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/camera/get_model");
  cardsflow_webots::get_string device_get_model_srv;
  ...
  cardsflow_webots::set_int accelerometer_srv;
  ros::Subscriber sub_accelerometer_32;
  ros::Subscriber sub_accelerometer_64;

  set_accelerometer_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/accelerometer/enable");
  ...
  cardsflow_webots::get_int sampling_period_accelerometer_srv;

  sampling_period_accelerometer_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/accelerometer/get_sampling_period");
  ...
  cardsflow_webots::set_int battery_sensor_srv;
  ros::Subscriber sub_battery_sensor_32;
  set_battery_sensor_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/battery_sensor/enable");

  ros::ServiceClient sampling_period_battery_sensor_client;
  cardsflow_webots::get_int sampling_period_battery_sensor_srv;
  sampling_period_battery_sensor_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/battery_sensor/get_sampling_period");
  ...
  cardsflow_webots::set_int compass_srv;
  ros::Subscriber sub_compass_32;
  set_compass_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/compass/enable");

  ros::ServiceClient sampling_period_compass_client;
  cardsflow_webots::get_int sampling_period_compass_srv;
  sampling_period_compass_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/compass/get_sampling_period");
  ...
  cardsflow_webots::set_int connector_srv;
  ros::Subscriber sub_connector;
  connector_enable_presence_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/connector/presence_sensor/enable");
  ...
  cardsflow_webots::set_bool connector_lock_srv;
  connector_lock_client = n.serviceClient<cardsflow_webots::set_bool>(model_name + "/connector/lock");
  ...
  cardsflow_webots::display_get_info display_get_info_srv;
  display_get_info_client = n.serviceClient<cardsflow_webots::display_get_info>(model_name + "/display/get_info");
  ...
  cardsflow_webots::set_int display_set_color_srv;
  display_set_color_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/display/set_color");
  ...
  cardsflow_webots::set_float display_set_alpha_srv;
  display_set_alpha_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/display/set_alpha");
  ...
  cardsflow_webots::set_float display_set_opacity_srv;
  display_set_opacity_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/display/set_opacity");
  ...
  cardsflow_webots::display_set_font display_set_font_srv;
  display_set_font_client = n.serviceClient<cardsflow_webots::display_set_font>(model_name + "/display/set_font");
  ...
  cardsflow_webots::display_draw_pixel display_draw_pixel_srv;
  display_draw_pixel_client = n.serviceClient<cardsflow_webots::display_draw_pixel>(model_name + "/display/draw_pixel");
  ...
  cardsflow_webots::display_draw_line display_draw_line_srv;
  display_draw_line_client = n.serviceClient<cardsflow_webots::display_draw_line>(model_name + "/display/draw_line");
  ...
  cardsflow_webots::display_draw_rectangle display_draw_rectangle_srv;
  display_draw_rectangle_client = n.serviceClient<cardsflow_webots::display_draw_rectangle>(model_name + "/display/draw_rectangle");
  ...
  cardsflow_webots::display_draw_oval display_draw_oval_srv;
  display_draw_oval_client = n.serviceClient<cardsflow_webots::display_draw_oval>(model_name + "/display/draw_oval");
  ...
  cardsflow_webots::display_draw_polygon display_draw_polygon_srv;
  display_draw_polygon_client = n.serviceClient<cardsflow_webots::display_draw_polygon>(model_name + "/display/draw_polygon");
  ...
  cardsflow_webots::display_draw_text display_draw_text_srv;
  display_draw_text_client = n.serviceClient<cardsflow_webots::display_draw_text>(model_name + "/display/draw_text");
  ...
  cardsflow_webots::display_draw_rectangle display_fill_rectangle_srv;
  display_fill_rectangle_client = n.serviceClient<cardsflow_webots::display_draw_rectangle>(model_name + "/display/fill_rectangle");
  ...
  cardsflow_webots::display_draw_oval display_fill_oval_srv;
  display_fill_oval_client = n.serviceClient<cardsflow_webots::display_draw_oval>(model_name + "/display/fill_oval");
  ...
  cardsflow_webots::display_draw_polygon display_fill_polygon_srv;
  display_fill_polygon_client = n.serviceClient<cardsflow_webots::display_draw_polygon>(model_name + "/display/fill_polygon");
  ...
  cardsflow_webots::display_image_new display_image_new_srv;
  display_image_new_client = n.serviceClient<cardsflow_webots::display_image_new>(model_name + "/display/image_new");
  ...
  cardsflow_webots::display_image_copy display_image_copy_srv;
  display_image_copy_client = n.serviceClient<cardsflow_webots::display_image_copy>(model_name + "/display/image_copy");
  ...
  cardsflow_webots::display_image_paste display_image_paste_srv;
  display_image_paste_client = n.serviceClient<cardsflow_webots::display_image_paste>(model_name + "/display/image_paste");
  ...
  cardsflow_webots::display_image_save display_image_save_srv;
  display_image_save_client = n.serviceClient<cardsflow_webots::display_image_save>(model_name + "/display/image_save");
  ...
  cardsflow_webots::display_image_load display_image_load_srv;
  display_image_load_client = n.serviceClient<cardsflow_webots::display_image_load>(model_name + "/display/image_load");
  ...
  cardsflow_webots::display_image_delete display_image_delete_srv;
  display_image_delete_client = n.serviceClient<cardsflow_webots::display_image_delete>(model_name + "/display/image_delete");
  ...
  cardsflow_webots::set_int distance_sensor_srv;
  ros::Subscriber sub_distance_sensor_32;
  set_distance_sensor_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/distance_sensor/enable");

  ros::ServiceClient sampling_period_distance_sensor_client;
  cardsflow_webots::get_int sampling_period_distance_sensor_srv;
  sampling_period_distance_sensor_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/distance_sensor/get_sampling_period");

  ros::ServiceClient min_value_distance_sensor_client;
  cardsflow_webots::get_float min_value_distance_sensor_srv;
  min_value_distance_sensor_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/distance_sensor/get_min_value");
  ...
  cardsflow_webots::get_float max_value_distance_sensor_srv;
  max_value_distance_sensor_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/distance_sensor/get_max_value");
  ...
  cardsflow_webots::get_float aperture_distance_sensor_srv;
  aperture_distance_sensor_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/distance_sensor/get_aperture");
  ...
  cardsflow_webots::set_string emitter_send_srv;
  emitter_send_client = n.serviceClient<cardsflow_webots::set_string>(model_name + "/emitter/send");
  ...
  cardsflow_webots::get_int emitter_get_buffer_size_srv;
  emitter_get_buffer_size_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/emitter/get_buffer_size");
  ...
  cardsflow_webots::set_int emitter_set_channel_srv;
  emitter_set_channel_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/emitter/set_channel");
  ...
  cardsflow_webots::set_float emitter_set_range_srv;
  emitter_set_range_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/emitter/set_range");
  ...
  cardsflow_webots::get_int emitter_get_channel_srv;
  emitter_get_channel_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/emitter/get_channel");
  ...
  cardsflow_webots::get_float emitter_get_range_srv;
  emitter_get_range_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/emitter/get_range");
  ...
  cardsflow_webots::set_int GPS_srv;
  ros::Subscriber sub_GPS_32;
  ros::Subscriber sub_GPS_speed;
  set_GPS_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/gps/enable");

  ros::ServiceClient sampling_period_GPS_client;
  cardsflow_webots::get_int sampling_period_GPS_srv;
  sampling_period_GPS_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/gps/get_sampling_period");
  ...
  cardsflow_webots::get_int gps_get_coordinate_system_srv;
  gps_get_coordinate_system_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/gps/get_coordinate_system");
  ...
  cardsflow_webots::set_int gyro_srv;
  ros::Subscriber sub_gyro_32;
  set_gyro_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/gyro/enable");

  ros::ServiceClient sampling_period_gyro_client;
  cardsflow_webots::get_int sampling_period_gyro_srv;
  sampling_period_gyro_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/gyro/get_sampling_period");
  ...
  cardsflow_webots::set_int inertial_unit_srv;
  ros::Subscriber sub_inertial_unit_32;
  set_inertial_unit_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/inertial_unit/enable");

  ros::ServiceClient sampling_period_inertial_unit_client;
  cardsflow_webots::get_int sampling_period_inertial_unit_srv;
  sampling_period_inertial_unit_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/inertial_unit/get_sampling_period");
  ...
  ros::ServiceClient enable_joystick_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/joystick/enable");
  cardsflow_webots::set_int enable_joystick_srv;
  ...
  cardsflow_webots::get_string joystick_get_model_srv;
  joystick_get_model_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/joystick/get_model");
  ...
  cardsflow_webots::set_int set_led_srv;
  set_led_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/led/set_led");
  ...
  cardsflow_webots::get_int get_led_srv;
  get_led_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/led/get_led");
  ...
  cardsflow_webots::set_int lidar_srv;
  ros::Subscriber sub_lidar;

  set_lidar_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/lidar/enable");
  ...
  // lidar_get_info
  get_info_client = n.serviceClient<cardsflow_webots::lidar_get_info>(model_name + "/lidar/get_info");
  cardsflow_webots::lidar_get_info get_lidar_info_srv;
  ...
  get_info_client = n.serviceClient<cardsflow_webots::lidar_get_frequency_info>(model_name + "/lidar/get_frequency_info");
  cardsflow_webots::lidar_get_frequency_info get_lidar_frequency_info_srv;
  ...
  cardsflow_webots::set_int light_sensor_srv;
  ros::Subscriber sub_light_sensor_32;
  set_light_sensor_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/light_sensor/enable");

  ros::ServiceClient sampling_period_light_sensor_client;
  cardsflow_webots::get_int sampling_period_light_sensor_srv;
  sampling_period_light_sensor_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/light_sensor/get_sampling_period");
  ...
  cardsflow_webots::get_int motor_get_type_srv;
  motor_get_type_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/rotational_motor/get_type");
  ...
  cardsflow_webots::get_int linear_motor_get_type_srv;
  linear_motor_get_type_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/linear_motor/get_type");
  ...
  cardsflow_webots::get_string motor_get_brake_name_srv;
  motor_get_brake_name_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/linear_motor/get_brake_name");
  ...
  cardsflow_webots::set_float set_acceleration_srv;
  set_acceleration_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/rotational_motor/set_acceleration");
  ...
  cardsflow_webots::set_float set_velocity_srv;
  set_velocity_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/rotational_motor/set_velocity");
  ...
  cardsflow_webots::set_float set_force_srv;
  set_force_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/linear_motor/set_force");
  ...
  cardsflow_webots::set_float set_torque_srv;
  set_torque_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/rotational_motor/set_torque");
  ...
  cardsflow_webots::set_float set_available_force_srv;
  set_available_force_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/linear_motor/set_available_force");
  ...
  cardsflow_webots::set_float set_available_torque_srv;
  set_available_torque_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/rotational_motor/set_available_torque");
  ...
  cardsflow_webots::motor_set_control_pid set_control_pid_srv;
  set_control_pid_client = n.serviceClient<cardsflow_webots::motor_set_control_pid>(model_name + "/rotational_motor/set_control_pid");
  ...
  cardsflow_webots::motor_set_control_pid set_linear_control_pid_srv;
  set_linear_control_pid_client =
    n.serviceClient<cardsflow_webots::motor_set_control_pid>(model_name + "/linear_motor/set_control_pid");
  ...
  cardsflow_webots::set_float set_position_srv;
  set_position_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/rotational_motor/set_position");
  ...
  cardsflow_webots::set_float set_linear_position_srv;
  set_linear_position_client = n.serviceClient<cardsflow_webots::set_float>(model_name + "/linear_motor/set_position");
  ...
  cardsflow_webots::get_float get_target_position_srv;
  get_target_position_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_target_position");
  ...
  cardsflow_webots::get_float get_min_position_srv;
  get_min_position_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_min_position");
  ...
  cardsflow_webots::get_float get_max_position_srv;
  get_max_position_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_max_position");
  ...
  cardsflow_webots::get_float get_velocity_srv;
  get_velocity_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_velocity");
  ...
  cardsflow_webots::get_float get_max_velocity_srv;
  get_max_velocity_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_max_velocity");
  ...
  cardsflow_webots::get_float get_acceleration_srv;
  get_acceleration_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_acceleration");
  ...
  cardsflow_webots::get_float get_available_force_srv;
  get_available_force_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_available_force");
  ...
  cardsflow_webots::get_float get_max_force_srv;
  get_max_force_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_max_force");
  ...
  cardsflow_webots::get_float get_available_torque_srv;
  get_available_torque_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_available_torque");
  ...
  cardsflow_webots::get_float get_max_torque_srv;
  get_max_torque_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/rotational_motor/get_max_torque");
  ...
  cardsflow_webots::pen_set_ink_color set_ink_color_srv;
  set_ink_color_client = n.serviceClient<cardsflow_webots::pen_set_ink_color>(model_name + "/pen/set_ink_color");
  ...
  cardsflow_webots::set_bool pen_write_srv;
  pen_write_client = n.serviceClient<cardsflow_webots::set_bool>(model_name + "/pen/write");
  ...
  cardsflow_webots::set_int position_sensor_srv;
  ros::Subscriber sub_position_sensor_32;
  set_position_sensor_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/position_sensor/enable");

  ros::ServiceClient sampling_period_position_sensor_client;
  cardsflow_webots::get_int sampling_period_position_sensor_srv;
  sampling_period_position_sensor_client =
    n.serviceClient<cardsflow_webots::get_int>(model_name + "/position_sensor/get_sampling_period");
  ...
  cardsflow_webots::get_int position_sensor_get_type_srv;
  position_sensor_get_type_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/position_sensor/get_type");
  ...
  cardsflow_webots::set_int radar_srv;
  ros::Subscriber sub_radar_target;
  ros::Subscriber sub_radar_target_number;

  set_radar_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/radar/enable");
  ...
  ros::ServiceClient radar_range_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/radar/get_max_range");
  cardsflow_webots::get_float radar_get_max_range_srv;
  ...
  radar_range_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/radar/get_min_range");
  cardsflow_webots::get_float radar_get_min_range_srv;
  ...
  cardsflow_webots::set_int range_finder_srv;
  ros::Subscriber sub_range_finder_color;

  set_range_finder_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/range_finder/enable");
  ...
  get_info_client = n.serviceClient<cardsflow_webots::range_finder_get_info>(model_name + "/range_finder/get_info");
  cardsflow_webots::range_finder_get_info get_range_finder_info_srv;
  ...
  save_image_client = n.serviceClient<cardsflow_webots::save_image>(model_name + "/range_finder/save_image");
  cardsflow_webots::save_image save_range_image_srv;
  ...
  cardsflow_webots::set_int receiver_srv;
  ros::Subscriber sub_receiver_32;
  set_receiver_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/receiver/enable");

  ros::ServiceClient sampling_period_receiver_client;
  cardsflow_webots::get_int sampling_period_receiver_srv;
  sampling_period_receiver_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/receiver/get_sampling_period");
  ...
  cardsflow_webots::get_int receiver_get_data_size_srv;
  receiver_get_data_size_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/receiver/get_data_size");
  ...
  cardsflow_webots::set_int receiver_set_channel_srv;
  receiver_set_channel_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/receiver/set_channel");
  ...
  cardsflow_webots::get_int receiver_get_channel_srv;
  receiver_get_channel_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/receiver/get_channel");
  ...
  cardsflow_webots::get_int receiver_get_queue_length_srv;
  receiver_get_queue_length_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/receiver/get_queue_length");
  ...
  cardsflow_webots::get_float receiver_get_signal_strength_srv;
  receiver_get_signal_strength_client = n.serviceClient<cardsflow_webots::get_float>(model_name + "/receiver/get_signal_strength");
  ...
  cardsflow_webots::receiver_get_emitter_direction receiver_get_emitter_direction_srv;
  receiver_get_emitter_direction_client =
    n.serviceClient<cardsflow_webots::receiver_get_emitter_direction>(model_name + "/receiver/get_emitter_direction");
  ...
  cardsflow_webots::get_bool receiver_next_packet_srv;
  receiver_next_packet_client = n.serviceClient<cardsflow_webots::get_bool>(model_name + "/receiver/next_packet");
  ...
  cardsflow_webots::set_int touch_sensor_srv;
  ros::Subscriber sub_touch_sensor_32;
  set_touch_sensor_client = n.serviceClient<cardsflow_webots::set_int>(model_name + "/touch_sensor/enable");

  ros::ServiceClient sampling_period_touch_sensor_client;
  cardsflow_webots::get_int sampling_period_touch_sensor_srv;
  sampling_period_touch_sensor_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/touch_sensor/get_sampling_period");

  ros::ServiceClient touch_sensor_get_type_client;
  cardsflow_webots::get_int touch_sensor_get_type_srv;
  touch_sensor_get_type_client = n.serviceClient<cardsflow_webots::get_int>(model_name + "/touch_sensor/get_type");
  ...
  cardsflow_webots::get_bool supervisor_simulation_reset_physics_srv;
  supervisor_simulation_reset_physics_client =
    n.serviceClient<cardsflow_webots::get_bool>(model_name + "/supervisor/simulation_reset_physics");
  ...
  cardsflow_webots::save_image supervisor_export_image_srv;
  supervisor_export_image_client = n.serviceClient<cardsflow_webots::save_image>(model_name + "/supervisor/export_image");
  ...
  cardsflow_webots::supervisor_set_label supervisor_set_label_srv;
  supervisor_set_label_client = n.serviceClient<cardsflow_webots::supervisor_set_label>(model_name + "/supervisor/set_label");
  ...
  cardsflow_webots::get_uint64 supervisor_get_root_srv;
  supervisor_get_root_client = n.serviceClient<cardsflow_webots::get_uint64>(model_name + "/supervisor/get_root");
  ...
  cardsflow_webots::get_uint64 supervisor_get_self_srv;
  supervisor_get_self_client = n.serviceClient<cardsflow_webots::get_uint64>(model_name + "/supervisor/get_self");
  ...
  cardsflow_webots::supervisor_get_from_def supervisor_get_from_def_srv;
  supervisor_get_from_def_client =
    n.serviceClient<cardsflow_webots::supervisor_get_from_def>(model_name + "/supervisor/get_from_def");
  ...
  cardsflow_webots::node_get_type supervisor_node_get_type_srv;
  supervisor_node_get_type_client = n.serviceClient<cardsflow_webots::node_get_type>(model_name + "/supervisor/node/get_type");
  ...
  cardsflow_webots::node_get_name supervisor_node_get_type_name_srv;
  supervisor_node_get_type_name_client =
    n.serviceClient<cardsflow_webots::node_get_name>(model_name + "/supervisor/node/get_type_name");
  ...
  cardsflow_webots::node_get_name supervisor_node_get_base_type_name_srv;
  supervisor_node_get_base_type_name_client =
    n.serviceClient<cardsflow_webots::node_get_name>(model_name + "/supervisor/node/get_base_type_name");
  ...
  cardsflow_webots::node_get_name supervisor_node_get_def_srv;
  supervisor_node_get_def_client = n.serviceClient<cardsflow_webots::node_get_name>(model_name + "/supervisor/node/get_def");
  ...
  cardsflow_webots::node_get_position supervisor_node_get_position_srv;
  supervisor_node_get_position_client =
    n.serviceClient<cardsflow_webots::node_get_position>(model_name + "/supervisor/node/get_position");
  ...
  cardsflow_webots::node_get_orientation supervisor_node_get_orientation_srv;
  supervisor_node_get_orientation_client =
    n.serviceClient<cardsflow_webots::node_get_orientation>(model_name + "/supervisor/node/get_orientation");
  ...
  cardsflow_webots::node_get_center_of_mass supervisor_node_get_center_of_mass_srv;
  supervisor_node_get_center_of_mass_client =
    n.serviceClient<cardsflow_webots::node_get_center_of_mass>(model_name + "/supervisor/node/get_center_of_mass");
  ...
  cardsflow_webots::node_get_number_of_contact_points supervisor_node_get_number_of_contact_points_srv;
  supervisor_node_get_number_of_contact_points_client = n.serviceClient<cardsflow_webots::node_get_number_of_contact_points>(
  ...
  cardsflow_webots::node_get_contact_point supervisor_node_get_contact_point_srv;
  supervisor_node_get_contact_point_client =
    n.serviceClient<cardsflow_webots::node_get_contact_point>(model_name + "/supervisor/node/get_contact_point");
  ...
  cardsflow_webots::node_get_static_balance supervisor_node_get_static_balance_srv;
  supervisor_node_get_static_balance_client =
    n.serviceClient<cardsflow_webots::node_get_static_balance>(model_name + "/supervisor/node/get_static_balance");
  ...
  ros::ServiceClient supervisor_node_reset_physics_client =
    n.serviceClient<cardsflow_webots::node_reset_functions>(model_name + "/supervisor/node/reset_physics");
  cardsflow_webots::node_reset_functions supervisor_node_reset_physics_srv;
  ...
  ros::ServiceClient supervisor_node_restart_controller_client =
    n.serviceClient<cardsflow_webots::node_reset_functions>(model_name + "/supervisor/node/restart_controller");
  cardsflow_webots::node_reset_functions supervisor_node_restart_controller_srv;
  ...
  cardsflow_webots::node_get_field supervisor_node_get_field_srv;
  supervisor_node_get_field_client = n.serviceClient<cardsflow_webots::node_get_field>(model_name + "/supervisor/node/get_field");
  ...
  cardsflow_webots::field_get_type supervisor_field_get_type_srv;
  supervisor_field_get_type_client = n.serviceClient<cardsflow_webots::field_get_type>(model_name + "/supervisor/field/get_type");
  ...
  cardsflow_webots::field_get_type_name supervisor_field_get_type_name_srv;
  supervisor_field_get_type_name_client =
    n.serviceClient<cardsflow_webots::field_get_type_name>(model_name + "/supervisor/field/get_type_name");
  ...
  cardsflow_webots::field_get_count supervisor_field_get_count_srv;
  supervisor_field_get_count_client = n.serviceClient<cardsflow_webots::field_get_count>(model_name + "/supervisor/field/get_count");
  ...
  cardsflow_webots::field_set_string supervisor_field_set_string_srv;
  supervisor_field_set_string_client =
    n.serviceClient<cardsflow_webots::field_set_string>(model_name + "/supervisor/field/set_string");
  ...
  cardsflow_webots::field_get_string supervisor_field_get_string_srv;
  supervisor_field_get_string_client =
    n.serviceClient<cardsflow_webots::field_get_string>(model_name + "/supervisor/field/get_string");
  ...
  cardsflow_webots::field_get_node supervisor_field_get_node_srv;
  supervisor_field_get_node_client = n.serviceClient<cardsflow_webots::field_get_node>(model_name + "/supervisor/field/get_node");
  ...
  cardsflow_webots::node_get_id node_get_id_srv;
  node_get_id_client = n.serviceClient<cardsflow_webots::node_get_id>(model_name + "/supervisor/node/get_id");
  ...
  cardsflow_webots::supervisor_get_from_id supervisor_get_from_id_srv;
  node_get_id_client = n.serviceClient<cardsflow_webots::supervisor_get_from_id>(model_name + "/supervisor/get_from_id");
  ...
  cardsflow_webots::node_set_velocity node_set_velocity_srv;
  node_velocity_client = n.serviceClient<cardsflow_webots::node_set_velocity>(model_name + "/supervisor/node/set_velocity");
  ...
  // node_get_velocity
  cardsflow_webots::node_get_velocity node_get_velocity_srv;
  node_velocity_client = n.serviceClient<cardsflow_webots::node_get_velocity>(model_name + "/supervisor/node/get_velocity");
  ...
  cardsflow_webots::node_get_parent_node node_get_parent_node_srv;
  node_get_parent_node_client =
    n.serviceClient<cardsflow_webots::node_get_parent_node>(model_name + "/supervisor/node/get_parent_node");
  ...
  cardsflow_webots::node_get_status supervisor_movie_is_ready_srv;
  supervisor_movie_is_ready_client = n.serviceClient<cardsflow_webots::node_get_status>(model_name + "/supervisor/movie_is_ready");
  ...
  cardsflow_webots::supervisor_movie_start_recording supervisor_movie_start_srv;
  supervisor_movie_start_client =
    n.serviceClient<cardsflow_webots::supervisor_movie_start_recording>(model_name + "/supervisor/movie_start_recording");
  ...
  cardsflow_webots::get_bool supervisor_movie_stop_srv;
  supervisor_movie_stop_client = n.serviceClient<cardsflow_webots::get_bool>(model_name + "/supervisor/movie_stop_recording");
  ...
  cardsflow_webots::node_get_status supervisor_movie_failed_srv;
  supervisor_movie_failed_client = n.serviceClient<cardsflow_webots::node_get_status>(model_name + "/supervisor/movie_failed");
  ...
  cardsflow_webots::field_remove field_remove_srv;
  remove_node_client = n.serviceClient<cardsflow_webots::field_remove>(model_name + "/supervisor/field/remove");
  ...
  // node_remove
  cardsflow_webots::node_remove node_remove_srv;
  remove_node_client = n.serviceClient<cardsflow_webots::node_remove>(model_name + "/supervisor/node/remove");
  ...
  wwi_send_client = n.serviceClient<cardsflow_webots::set_string>(model_name + "/robot/wwi_send_text");
  cardsflow_webots::set_string wwi_send_srv;
  ...
  wwi_receive_client = n.serviceClient<cardsflow_webots::get_string>(model_name + "/robot/wwi_receive_text");
  cardsflow_webots::get_string wwi_receive_srv;
  ...
  cardsflow_webots::get_bool supervisor_virtual_reality_headset_is_used_srv;
  virtual_reality_headset_client =
    n.serviceClient<cardsflow_webots::get_bool>(model_name + "/supervisor/vitual_reality_headset_is_used");
  ...
  //  cardsflow_webots::field_import_node supervisor_field_import_node_srv;
  //  supervisor_field_import_node_client =
  //  n.serviceClient<cardsflow_webots::field_import_node>(model_name+"/supervisor/field/import_node");
  //
  ...
  //~ cardsflow_webots::set_int supervisor_simulation_quit_srv;
  //~ supervisor_simulation_quit_client = n.serviceClient<cardsflow_webots::set_int>(model_name+"/supervisor/simulation_quit");
  //~
  ...
  //~ cardsflow_webots::get_bool supervisor_simulation_revert_srv;
  //~ supervisor_simulation_revert_client = n.serviceClient<cardsflow_webots::get_bool>(model_name+"/supervisor/simulation_revert");
  //~

...
int main(int argc, char **argv) {
  ...
  // get world node
  ros::ServiceClient getWorldClient = n.serviceClient<cardsflow_webots::get_uint64>(controllerName + "/supervisor/get_root");
  cardsflow_webots::get_uint64 getWorldSrv;
  getWorldClient.call(getWorldSrv);

  // get children list
  ros::ServiceClient getWorldChildrenClient =
    n.serviceClient<cardsflow_webots::node_get_field>(controllerName + "/supervisor/node/get_field");
  cardsflow_webots::node_get_field getWorldChildrenSrv;
  ...
  ros::ServiceClient getPovClient = n.serviceClient<cardsflow_webots::field_get_node>(controllerName + "/supervisor/field/get_node");
  cardsflow_webots::field_get_node getPovSrv;
  ...
  ros::ServiceClient getPovPositionFieldClient =
    n.serviceClient<cardsflow_webots::node_get_field>(controllerName + "/supervisor/node/get_field");
  cardsflow_webots::node_get_field getPovPositionFieldSrv;
  ...
  ros::ServiceClient getPositionClient =
    n.serviceClient<cardsflow_webots::field_get_vec3f>(controllerName + "/supervisor/field/get_vec3f");
  cardsflow_webots::field_get_vec3f getPovPositionSrv;
  ...
  ros::ServiceClient getPovOrientationFieldClient =
    n.serviceClient<cardsflow_webots::node_get_field>(controllerName + "/supervisor/node/get_field");
  cardsflow_webots::node_get_field getPovOrientationFieldSrv;
  ...
  ros::ServiceClient getPovOrientationClient =
    n.serviceClient<cardsflow_webots::field_get_rotation>(controllerName + "/supervisor/field/get_rotation");
  cardsflow_webots::field_get_rotation getPovOrientationSrv;
  ...
  ros::ServiceClient setPositionClient =
    n.serviceClient<cardsflow_webots::field_set_vec3f>(controllerName + "/supervisor/field/set_vec3f");
  cardsflow_webots::field_set_vec3f setPovPositionSrv;
  ...
  ros::ServiceClient setPovOrientationClient =
    n.serviceClient<cardsflow_webots::field_set_rotation>(controllerName + "/supervisor/field/set_rotation");
  cardsflow_webots::field_set_rotation setPovOrientationSrv;
  ...
  cardsflow_webots::supervisor_set_label supervisorSetLabelSrv;
  supervisorSetLabelClient = n.serviceClient<cardsflow_webots::supervisor_set_label>(controllerName + "/supervisor/set_label");
  ...
  cardsflow_webots::supervisor_movie_start_recording supervisorMovieStartSrv;
  supervisorMovieStartClient =
    n.serviceClient<cardsflow_webots::supervisor_movie_start_recording>(controllerName + "/supervisor/movie_start_recording");
  ...
  cardsflow_webots::get_bool supervisorMovieStopSrv;
  supervisorMovieStopClient = n.serviceClient<cardsflow_webots::get_bool>(controllerName + "/supervisor/movie_stop_recording");

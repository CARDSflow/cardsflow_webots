...
// here 'cardsflow_webots' is the name of the package used for this node. Replace it by your own package.
...
int main(int argc, char **argv) {
  ...
  ros::ServiceClient getTypeClient = n.serviceClient<cardsflow_webots::get_int>(controllerName + "/robot/get_type");
  cardsflow_webots::get_int getTypeSrv;
  ros::ServiceClient getModelClient = n.serviceClient<cardsflow_webots::get_string>(controllerName + "/robot/get_model");
  cardsflow_webots::get_string getModelSrv;

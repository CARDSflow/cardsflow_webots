...
cardsflow_webots::set_float leftWheelSrv;

ros::ServiceClient rightWheelClient;
cardsflow_webots::set_float rightWheelSrv;

ros::ServiceClient timeStepClient;
cardsflow_webots::set_int timeStepSrv;

ros::ServiceClient enableKeyboardClient;
cardsflow_webots::set_int enableKeyboardSrv;
...
int main(int argc, char **argv) {
  ...
  leftWheelClient = n.serviceClient<cardsflow_webots::set_float>(controllerName + "/left_wheel/set_position");
  rightWheelClient = n.serviceClient<cardsflow_webots::set_float>(controllerName + "/right_wheel/set_position");
  timeStepClient = n.serviceClient<cardsflow_webots::set_int>(controllerName + "/robot/time_step");
  timeStepSrv.request.value = TIME_STEP;

  enableKeyboardClient = n.serviceClient<cardsflow_webots::set_int>(controllerName + "/keyboard/enable");
